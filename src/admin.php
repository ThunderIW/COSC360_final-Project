    ...
    <div class="nav-container">
        ...
        <div class="profile-container">
            <button class="profile-button" id="user-menu-button">
                <img src="<?php echo (!empty($userImage)) ? 'data:image/png;base64,' . $userImage : 'assets/emptyIcon.png'; ?>" alt="User Profile" />
            </button>
...
<section class="admin">
        ...
        <div class="delete">
            ...
            <div class="searching_users">
                <form method="GET" action="admin.php">
                    <input type="text" name="findUsers" value="<?php echo isset($_GET['findUsers']) ? htmlspecialchars($_GET['findUsers']) : ''; ?>"
    ...
    <div class="add_dino">
        ...
        <form class="add_dino_form_section" method="POST" action="dinosaur_validate.php" enctype="multipart/form-data">
            <label> Name:</label>
