    ...
    <body>
        ...
        <div id="ProductItem">
            ...
            <div id="ProductDesc">
                ...
                <div id="Amount">
                    <div id="inputs">
                        <form id="addingToCart">
                            <input type="hidden" id="dino_id" name="dino_id" value="<?php echo $id; ?>">
        ...
        <script>
            document.getElementById("addingToCart").addEventListener("submit", function (e) {
                e.preventDefault();
                <?php if (!isset($_SESSION['id'])): ?>
                    alert("You must be logged inorder to add dinsoaurs to the cart!");
                <?php else: ?>
                    const dinoId = document.getElementById('dino_id').value;
                    const quantity = document.getElementById('quantity').value;
                    const jsonData = {
                        dino_id: dinoId,
                        quantity: parseInt(quantity)
                    };
                    fetch("AddingDinoTocart.php", {
                        method: "POST",
                        headers: {
                        ...
                        .catch(error => {
                            alert("There's an issue when adding a dinosaur!");
                        });
                <?php endif; ?>
            });
        </script>
